...
const AWS_I18N = {
  en: {
    ...
    meta_desc: `Aruba Wakeboard School (AWS), founded 2008 in Oranjestad. Aruba's dedicated wakeboard school — private wakeboarding lessons for every level. 30-minute sessions, $50 per person. Open weekends.`,
    ...
    nav_pricing: `Pricing`,
    nav_faq: `FAQ`,
    btn_book: `Check availability`,

    hero_location: `Bucutiweg, Oranjestad · Aruba`,
    hero_h1: `<em>The</em> wakeboard school on the island`,
    hero_lede: `Founded in 2008, AWS is Aruba's dedicated wakeboard school. Private lessons in the calm, warm water off Oranjestad, for first-timers through advanced riders. Head instructor Edirik gets you up and riding in a single 30-minute session.`,
    hero_cta_options: `See lesson options`,
    hero_note: `30 min · $50 per person · Boards & vests included · Open weekends`,
    ...
    faq_a3: `We're at Bucutiweg in Oranjestad, Aruba. On Google Maps, search for <strong>"Pure Diving Aruba"</strong> — that's our spot. We'll send a pin and parking info once your time is confirmed.`,
  ...
  nl: {
    ...
    meta_desc: `Aruba Wakeboard School (AWS), opgericht in 2008 in Oranjestad. Dé gespecialiseerde wakeboardschool van Aruba — privélessen wakeboarden voor elk niveau. Sessies van 30 minuten, $50 per persoon. Open in het weekend.`,
    ...
    nav_pricing: `Prijzen`,
    nav_faq: `FAQ`,
    btn_book: `Beschikbaarheid checken`,

    hero_location: `Bucutiweg, Oranjestad · Aruba`,
    hero_h1: `<em>Dé</em> wakeboardschool van het eiland`,
    hero_lede: `Opgericht in 2008 is AWS dé gespecialiseerde wakeboardschool van Aruba. Privélessen in het rustige, warme water voor de kust van Oranjestad, voor complete beginners tot gevorderden. Hoofdinstructeur Edirik krijgt je in één sessie van 30 minuten op het board.`,
    hero_cta_options: `Bekijk de lesopties`,
    hero_note: `30 min · $50 p.p. · Boards & zwemvesten inbegrepen · Open in het weekend`,
    ...
    plan2_desc: `Bespaar $15 — ideaal om echt vooruitgang te maken.`,
    ...
    plan2_btn: `Beschikbaarheid checken`,
    plan3_h: `Groep / gezin`,
    ...
    plan3_btn: `Beschikbaarheid checken`,
    ...
    faq_a3: `We zitten aan de Bucutiweg in Oranjestad, Aruba. Zoek in Google Maps op <strong>"Pure Diving Aruba"</strong> — dat is onze plek. Zodra je tijd bevestigd is, sturen we een pin en parkeerinfo.`,
  ...
  es: {
    ...
    meta_desc: `Aruba Wakeboard School (AWS), fundada en 2008 en Oranjestad. La escuela de wakeboard especializada de Aruba — clases privadas de wakeboard para todos los niveles. Sesiones de 30 minutos, $50 por persona. Abierto los fines de semana.`,
    ...
    nav_pricing: `Precios`,
    nav_faq: `Preguntas`,
    btn_book: `Consultar disponibilidad`,

    hero_location: `Bucutiweg, Oranjestad · Aruba`,
    hero_h1: `<em>La</em> escuela de wakeboard de la isla`,
    hero_lede: `Fundada en 2008, AWS es la escuela de wakeboard especializada de Aruba. Clases privadas en las aguas tranquilas y cálidas de Oranjestad, desde principiantes hasta riders avanzados. El instructor principal, Edirik, te pone de pie sobre la tabla en una sola sesión de 30 minutos.`,
    hero_cta_options: `Ver opciones de clase`,
    hero_note: `30 min · $50 por persona · Tablas y chalecos incluidos · Abierto fines de semana`,
    ...
    plan2_btn: `Consultar disponibilidad`,
    ...
    plan3_btn: `Consultar disponibilidad`,
    ...
    faq_q2: `¿Cuándo abren?`,
    faq_a2: `Sábados y domingos, aproximadamente de 9:00 a 18:00. Escríbenos para apartar tu hueco: en temporada alta los fines de semana se llenan.`,
    faq_q3: `¿Dónde nos encontramos?`,
    faq_a3: `Estamos en Bucutiweg, Oranjestad, Aruba. En Google Maps busca <strong>"Pure Diving Aruba"</strong>: ese es nuestro sitio. Cuando confirmemos tu hora te enviamos la ubicación y la info de aparcamiento.`,
